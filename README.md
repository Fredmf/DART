...
curl -LO https://github.com/Fredmf/DART/releases/download/v0.0.4/dart-init.sh
...
This is v0.0.4. The methodology will evolve as people use it and discover what works. Open issues for suggestions, sharp edges, or things that don't survive contact with real projects.
